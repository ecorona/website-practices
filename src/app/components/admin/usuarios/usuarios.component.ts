...
export class UsuariosComponent implements OnInit {
  ...
  agregarUsuario(value){
    ...
    this._usuarios.crearUsuario({ //lanzar solicitud desde el service, recordemos que regresará un http request
      nombre:    value.nombre,
      activo:    value.activo,
      email:     value.email,
  ...
  buscarUsuarios(){
    ...
    this._usuarios.buscarUsuarios().subscribe(resp =>{
