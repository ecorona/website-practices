...
export class RegistroComponent{
  ...
  constructor( private router: Router, private _registro: RegistroService, private _builder: FormBuilder) {
   ...
   registrar(value){
     ...
     this._registro.registrar({
        ...
        this._registro.setRegistrado( resp.data );
